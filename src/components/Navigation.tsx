...
export function Navigation() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-8 lg:px-16 flex items-center justify-between">
          ...
          <a
            ...
            className="text-h6 font-medium text-white hover:text-gold hover:text-shadow-glow transition-all duration-300"
          >
      ...
      {/* Mobile menu */}
      <div
        className={`fixed inset-0 z-40 bg-black transition-all duration-500 lg:hidden ${isMobileMenuOpen
